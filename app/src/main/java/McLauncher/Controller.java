    ...
    class LaunchThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                gameInstaller.init(App.gamePath);
                gameInstaller.addObserver(new DlListenner());
                gameInstaller.download(App.gamePath, App.version);
                String cassPath = new ClassPathBuilder(App.gamePath).build();

                GameProfile gameProfile = new GameProfile(account, saveUtils.get("ramMax"), saveUtils.get("assetId"), App.gamePath, App.version, cassPath , App.gameType, saveUtils.get("logConfigPath") );
